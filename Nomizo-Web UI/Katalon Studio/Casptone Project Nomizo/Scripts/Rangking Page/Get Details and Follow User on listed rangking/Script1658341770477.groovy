...
WebUI.click(findTestObject('Ranking/Ranking Page'))

WebUI.click(findTestObject('Ranking/div_User Ranking'))

WebUI.click(findTestObject('Ranking/span_User Ranking'))

WebUI.verifyElementPresent(findTestObject('Ranking/span_Username pakBudRT03'), 0)

WebUI.click(findTestObject('Ranking/button_Follow User'))
