...
WebUI.click(findTestObject('Ranking/div_Topic Ranking'))

WebUI.click(findTestObject('Ranking/Topic Sport'))

WebUI.verifyElementPresent(findTestObject('Ranking/Validasi_Tentang Topik Ini'), 0)

WebUI.click(findTestObject('Ranking/button_Follow'))
