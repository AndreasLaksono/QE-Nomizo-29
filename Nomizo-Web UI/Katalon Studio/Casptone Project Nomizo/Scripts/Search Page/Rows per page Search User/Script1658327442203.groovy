...
WebUI.click(findTestObject('Search Page/Page_frontend-vue - frontend-vue/div_Rows per page User'))

WebUI.click(findTestObject('Search Page/Page_frontend-vue - frontend-vue/div_row 5 User'))
