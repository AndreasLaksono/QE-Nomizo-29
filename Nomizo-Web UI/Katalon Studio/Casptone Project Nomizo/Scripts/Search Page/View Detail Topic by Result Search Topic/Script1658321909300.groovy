...
WebUI.click(findTestObject('Search Page/Page_frontend-vue - frontend-vue/Topic Hewan'))

WebUI.verifyElementPresent(findTestObject('Search Page/Page_frontend-vue - frontend-vue/Validasi_Tentang Topic ini'), 0)
