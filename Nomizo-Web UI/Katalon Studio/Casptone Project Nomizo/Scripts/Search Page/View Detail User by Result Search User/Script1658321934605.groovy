...
WebUI.setText(findTestObject('Search Page/Page_frontend-vue - frontend-vue/input_search page'), 'Elf')

WebUI.sendKeys(findTestObject('Search Page/Page_frontend-vue - frontend-vue/input_search page'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Search Page/Page_frontend-vue - frontend-vue/div_User'))

WebUI.click(findTestObject('Search Page/Page_frontend-vue - frontend-vue/User Elfnov1234'))

WebUI.verifyElementPresent(findTestObject('Search Page/Page_frontend-vue - frontend-vue/Validasi_Username Elfnov123'), 0)
