...
WebUI.click(findTestObject('Search Page/Page_frontend-vue - frontend-vue/Rows per page topic'))

WebUI.click(findTestObject('Search Page/Page_frontend-vue - frontend-vue/div_row 5 Topic'))
