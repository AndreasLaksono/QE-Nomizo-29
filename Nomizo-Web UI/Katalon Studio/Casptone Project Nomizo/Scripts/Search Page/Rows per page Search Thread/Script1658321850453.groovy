...
WebUI.setText(findTestObject('Search Page/Page_frontend-vue - frontend-vue/input_search page'), 'Hewan')

WebUI.sendKeys(findTestObject('Search Page/Page_frontend-vue - frontend-vue/input_search page'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Search Page/Page_frontend-vue - frontend-vue/div_Thread'))

WebUI.click(findTestObject('Search Page/Page_frontend-vue - frontend-vue/div_Rows per page thread'))

WebUI.click(findTestObject('Search Page/Page_frontend-vue - frontend-vue/div_row 10 Thread'))
