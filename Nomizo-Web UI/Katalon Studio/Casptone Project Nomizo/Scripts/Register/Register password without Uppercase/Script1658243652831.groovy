...
WebUI.setEncryptedText(findTestObject('Register/input__PasswordRegist'), GlobalVariable.passnotUppercase)

WebUI.click(findTestObject('Register/Field_ConfirmPass'))

WebUI.setEncryptedText(findTestObject('Register/input__ConfirmPass'), GlobalVariable.passnotUppercase)

WebUI.verifyElementText(findTestObject('Register/Alert Message Password Kapital'), 'Password harus mengandung setidaknya satu huruf kapital')
