...
WebUI.setText(findTestObject('Register/input__Email'), 'TestUser2@gmail.com')
...
WebUI.setEncryptedText(findTestObject('Register/input__PasswordRegist'), GlobalVariable.passnotNumber)

WebUI.click(findTestObject('Register/Field_ConfirmPass'))

WebUI.setEncryptedText(findTestObject('Register/input__ConfirmPass'), GlobalVariable.passnotNumber)

WebUI.verifyElementText(findTestObject('Register/Alert Message Password Number'), 'Password harus mengandung setidaknya satu angka')
