...
WebUI.setEncryptedText(findTestObject('Register/input__ConfirmPass'), GlobalVariable.adminPassword)

WebUI.waitForElementPresent(findTestObject('Register/Alert Message Confirm Pass Mismatch'), 0)
