...
WebUI.setText(findTestObject('Register/input__Email'), '')
...
WebUI.verifyElementText(findTestObject('Register/Alert Message Null Email'), 'Masukkan alamat e-mail anda')
