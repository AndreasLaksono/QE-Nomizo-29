...
WebUI.setEncryptedText(findTestObject('Register/input__PasswordRegist'), GlobalVariable.passnotspecialchara)

WebUI.click(findTestObject('Register/Field_ConfirmPass'))

WebUI.setEncryptedText(findTestObject('Register/input__ConfirmPass'), GlobalVariable.passnotspecialchara)
