...
WebUI.setEncryptedText(findTestObject('Register/input__PasswordRegist'), GlobalVariable.Passregistunder8)

WebUI.click(findTestObject('Register/Field_ConfirmPass'))

WebUI.setEncryptedText(findTestObject('Register/input__ConfirmPass'), GlobalVariable.Passregistunder8)

WebUI.verifyElementText(findTestObject('Register/Alert Message Password minimal 8 karakter'), 'Password minimal 8 karakter')
