...
WebUI.scrollToElement(findTestObject('Home Page/Page_Thread Post/Scroll Thread'), 0)

WebUI.click(findTestObject('Home Page/Page_Thread Post/Thread Next Image'))

WebUI.click(findTestObject('Home Page/Page_Thread Post/icon_next Image'))
