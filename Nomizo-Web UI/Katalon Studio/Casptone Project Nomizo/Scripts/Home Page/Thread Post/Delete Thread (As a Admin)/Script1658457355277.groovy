...
WebUI.setText(findTestObject('Search Page/Page_frontend-vue - frontend-vue/input_search page'), 'Manfaat pisang')

WebUI.sendKeys(findTestObject('Search Page/Page_frontend-vue - frontend-vue/input_search page'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Home Page/Page_Thread Post/Titik Tiga Delete Thread'))

WebUI.click(findTestObject('Home Page/Page_Thread Post/Hapus Thread'), FailureHandling.STOP_ON_FAILURE)
