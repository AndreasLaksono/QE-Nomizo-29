...
WebUI.click(findTestObject('Home Page/Page_Thread Post/Title Thread'))

WebUI.click(findTestObject('Home Page/Page_Thread Post/Titik Tiga'))

WebUI.click(findTestObject('Home Page/Page_Thread Post/div_Laporkan'))

WebUI.delay(2)

WebUI.click(findTestObject('Home Page/Page_Thread Post/div_Melanggar hak cipta'))

WebUI.click(findTestObject('Home Page/Page_Thread Post/button_Laporkan'))
