...
WebUI.scrollToElement(findTestObject('Home Page/Page_Hot Contributor/span_View More'), 0)

WebUI.click(findTestObject('Home Page/Page_Hot Contributor/span_View More'))

WebUI.scrollToElement(findTestObject('Home Page/Page_Hot Contributor/span_View Less'), 0)

WebUI.click(findTestObject('Home Page/Page_Hot Contributor/span_View Less'))
