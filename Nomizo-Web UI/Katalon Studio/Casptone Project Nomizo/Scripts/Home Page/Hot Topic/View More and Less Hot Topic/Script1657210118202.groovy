...
WebUI.click(findTestObject('Home Page/Page_Hot Topic/span_View More Hot Topic'))

WebUI.scrollToElement(findTestObject('Home Page/Page_Hot Topic/span_View Less Hot Topic'), 0)

WebUI.click(findTestObject('Home Page/Page_Hot Topic/span_View Less Hot Topic'))
