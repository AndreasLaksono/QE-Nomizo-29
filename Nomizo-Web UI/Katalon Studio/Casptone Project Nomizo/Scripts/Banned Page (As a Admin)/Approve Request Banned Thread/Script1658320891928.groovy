...
WebUI.click(findTestObject('Object Repository/Banned Page/Banned Page'))

WebUI.click(findTestObject('Banned Page/div_Thread'))

WebUI.click(findTestObject('Banned Page/Details Topic Banned Architecture'))

WebUI.click(findTestObject('Topics Page/button_Blokir Topics'))
