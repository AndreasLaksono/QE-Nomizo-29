...
WebUI.click(findTestObject('Banned Page/div_User'))

WebUI.click(findTestObject('Banned Page/Details User Banned Abdul123'))

WebUI.click(findTestObject('User Page/button_Blokir User'))
