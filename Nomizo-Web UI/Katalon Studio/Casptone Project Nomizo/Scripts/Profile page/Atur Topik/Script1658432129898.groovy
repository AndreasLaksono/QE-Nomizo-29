...
WebUI.click(findTestObject('Profile Page/Detail Atur Topik'))

WebUI.verifyElementClickable(findTestObject('Profile Page/Page_frontend-vue - frontend-vue/button_Keluar Sebagai Moderator'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementClickable(findTestObject('Profile Page/Page_frontend-vue - frontend-vue/button_Ubah Deskripsi'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementClickable(findTestObject('Profile Page/Page_frontend-vue - frontend-vue/button_Ubah Rules'), FailureHandling.STOP_ON_FAILURE)
