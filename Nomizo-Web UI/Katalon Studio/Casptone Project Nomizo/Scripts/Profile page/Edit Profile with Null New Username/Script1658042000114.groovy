...
WebUI.setText(findTestObject('Profile Page/input_email'), 'Elfnovember27@gmail.com')
...
WebUI.verifyElementPresent(findTestObject('Profile Page/Alert_masukan username baru'), 0)
