...
WebUI.setText(findTestObject('Profile Page/Input_username baru'), 'Megane-chan')

WebUI.setText(findTestObject('Profile Page/input_deskripsi profile (Optional)'), 'Saya Suka Kaca Mata')
...
WebUI.click(findTestObject('Profile Page/Input Tanggal Lahir'))

WebUI.click(findTestObject('Profile Page/Tahun Lahir'))

WebUI.click(findTestObject('Profile Page/Tahun 1999'))

WebUI.click(findTestObject('Profile Page/Bulan November'))

WebUI.click(findTestObject('Profile Page/Tanggal 30'))

WebUI.click(findTestObject('Profile Page/OK tanggal Lahir'))

WebUI.scrollToElement(findTestObject('Profile Page/button_unggah foto'), 0)

WebUI.verifyElementClickable(findTestObject('Profile Page/button_ubah profile'))
