...
WebUI.setText(findTestObject('Profile Page/Input_username baru'), '')

WebUI.setText(findTestObject('Profile Page/input_deskripsi profile (Optional)'), 'Saya Suka Kacamata')

WebUI.setText(findTestObject('Profile Page/input_email'), '')

WebUI.setText(findTestObject('Profile Page/input_jenis kelamin'), '')

WebUI.click(findTestObject('Profile Page/input_email'))
...
WebUI.verifyElementPresent(findTestObject('Profile Page/Alert_masukan jenis kelamin'), 0)
