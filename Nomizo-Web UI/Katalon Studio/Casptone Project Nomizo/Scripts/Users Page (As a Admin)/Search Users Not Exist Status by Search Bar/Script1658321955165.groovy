...
WebUI.click(findTestObject('Object Repository/User Page/Users Page'))

WebUI.setText(findTestObject('Object Repository/User Page/input_Search bar Users Page'), 'UserAlienFromMars')

WebUI.verifyElementPresent(findTestObject('User Page/Validasi_User Not Found'), 0)
