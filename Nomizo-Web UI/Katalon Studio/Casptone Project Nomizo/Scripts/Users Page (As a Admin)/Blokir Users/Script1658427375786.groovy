...
WebUI.click(findTestObject('User Page/Users Page'))

WebUI.click(findTestObject('User Page/Span User Listed'))

WebUI.verifyElementNotClickable(findTestObject('User Page/button_Blokir User'))
