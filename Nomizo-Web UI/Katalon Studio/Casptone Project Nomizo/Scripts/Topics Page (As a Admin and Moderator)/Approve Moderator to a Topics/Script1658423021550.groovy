...
WebUI.click(findTestObject('Topics Page/button_Details Food Topic'))

WebUI.click(findTestObject('Topics Page/button_Add Moderators of Topics'))

WebUI.waitForElementPresent(findTestObject('Topics Page/Page_frontend-vue - frontend-vue/button_Aprove'), 0)

WebUI.click(findTestObject('Topics Page/Page_frontend-vue - frontend-vue/button_Aprove'))

WebUI.verifyElementPresent(findTestObject('Topics Page/Page_frontend-vue - frontend-vue/div_Permintaan moderator berhasil diterima'), 
    0)
