...
WebUI.setText(findTestObject('Topics Page/input_Search Topic'), 'Food')

WebUI.click(findTestObject('Topics Page/button_Details Search'))

WebUI.verifyElementPresent(findTestObject('Topics Page/Validasi Details Topics'), 0)
