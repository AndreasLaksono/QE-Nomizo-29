...
WebUI.setText(findTestObject('Topics Page/input_Search bar Topics'), 'budi')

WebUI.verifyElementPresent(findTestObject('Topics Page/Validasi_Moderator Appears'), 0)
