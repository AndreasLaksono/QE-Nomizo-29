...
WebUI.waitForElementPresent(findTestObject('Topics Page/Page_frontend-vue - frontend-vue/button_Reject'), 0)

WebUI.click(findTestObject('Topics Page/Page_frontend-vue - frontend-vue/button_Reject'))

WebUI.verifyElementPresent(findTestObject('Topics Page/Page_frontend-vue - frontend-vue/div_Permintaan moderator berhasil ditolak'), 
    0)
