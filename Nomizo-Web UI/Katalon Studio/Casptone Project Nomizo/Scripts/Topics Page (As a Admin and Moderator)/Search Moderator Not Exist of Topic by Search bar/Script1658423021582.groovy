...
WebUI.setText(findTestObject('Topics Page/input_Search bar Topics'), 'xybgtajsmkwei')

WebUI.verifyElementPresent(findTestObject('Topics Page/Validasi_Moderator Not Found'), 
    0)
